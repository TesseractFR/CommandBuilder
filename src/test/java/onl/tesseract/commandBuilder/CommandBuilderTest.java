...
class CommandBuilderTest {
    ...
    public void setFlySpeedPlayerErrorInvalidNumber()
    {
        ...
        moneyCommand.build(null).execute(sender, new String[] {"GabRay", "invalid number"});
    ...
    public void argWithDependencyError()
    {
        ...
        getParcelCommand.build(null).execute(sender, new String[] {"inexistent guild", "maison"});
        verify(sender, times(1)).sendMessage(anyString());
    }
    ...
    public void permissionAllow()
    {
        ...
        cmd.build(null).execute(sender, new String[] {"subCmd"});
